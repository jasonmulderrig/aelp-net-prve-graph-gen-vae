...
def core_to_pb_nodes_func(
    ...
    Args:
        core_nodes (np.ndarray): Core nodes.
        pb_to_core_nodes (np.ndarray): np.ndarray that returns the core node that corresponds to each core and periodic boundary node, i.e., pb_to_core_nodes[core_pb_node] = core_node.
