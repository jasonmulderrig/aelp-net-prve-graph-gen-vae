...
def main(cfg: DictConfig) -> None:
    ...
    ##### Plot the topological descriptors for each artificial bimodal
...
if __name__ == "__main__":
    ...
    print(f"Artificial bimodal end-linked polymer network topology descriptors plotting took {execution_time} seconds to run")