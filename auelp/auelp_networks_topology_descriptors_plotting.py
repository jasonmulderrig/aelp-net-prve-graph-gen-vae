...
from src.networks.auelp_networks_config import sample_params_arr_func
...
def main(cfg: DictConfig) -> None:
    ...
    ##### Plot the topological descriptors for each artificial uniform
...
if __name__ == "__main__":
    ...
    print(f"Artificial uniform end-linked polymer network topology descriptors plotting took {execution_time} seconds to run")